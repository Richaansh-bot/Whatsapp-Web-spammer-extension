...
(function() {
  ...
  function doSpam(spamButton) {
    ...
    if (spamButton.innerHTML === 'SPAM') {
      ...
      let interval = 500 * parseInt(prompt('Please enter spam-interval in seconds/2:', 'Made by Richaansh™#𝙍𝙚𝙐𝙉𝙞𝙏𝙚𝘿🇮🇳'));
      if (!interval) {
        spamButton.innerHTML = 'SPAM';
  ...
  function sendMessage() {
    ...
    document.getElementsByClassName('_1E0Oz')[0].click(); // click send button & Enjoy 
  }
  })();